    ...
    <>
      ...
      <form onSubmit = {handleSubmit} className='flex flex-col gap-6 w-full h-auto px-2 lg:px-16'>
        ...
        <div className='flex gap-2 flex-wrap justify-center'>
          ...
          <p className='text-muted-foreground font-bold underline text-sm duration-150 hover:text-destructive hover:cursor-pointer'> <Link to = '/signup' >Create an account</Link> </p>
        </div>
